            ...
            <div class="login-form">
                ...
                <form action="${loginUrl}" method="post" class="form-horizontal">
                    ...
                    <div class="form-actions">
                        <input style="margin-left:10px; width:96%" type="submit"
                               class="btn btn-primary btn-default" value="Log in">
                    </div>
                    <div>
                        <input style="margin-left:185px" type="checkbox" id="remember-me" name="remember-me">
 ...
 */
    ...
    .btn btn-block btn-primary btn-default {
